...
{ 
    printf("\nResult: %s\n", yyvsp[0].dval); 
    free(yyvsp[0].dval); // Free the string
;
    break;}
case 2:
#line 36 "3ac.y"
...
#line 39 "3ac.y"
{
    yyval.dval = gencode("t", yyvsp[-2].dval, '+', yyvsp[0].dval);
    free(yyvsp[-2].dval); free(yyvsp[0].dval); // Free the strings
;
    break;}
case 4:
#line 43 "3ac.y"
